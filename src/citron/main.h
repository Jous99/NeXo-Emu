...
public:
    ...
    void UpdateUITheme();
    void OfferNeXoByamlDownload(u64 title_id);
    void NeXoByamlDownloadFromMenu(u64 title_id);
    bool NeXoByamlRequired(u64 title_id) const;
    bool NeXoByamlInstalled(u64 title_id) const;
    bool NeXoByamlSkipped(u64 title_id) const;
    bool NeXoByamlDownloadEnabled() const;
    ...
    void SilentlyDownloadNeXoByaml(u64 title_id);
signals:
...
private:
    ...
    QTimer nexo_presence_timer;
    std::string nexo_last_pushed_app_id;
    NeXoController* nexo_controller = nullptr;
    NeXoToast* nexo_toast = nullptr;
    QDialog* nexo_signin_dialog = nullptr;
    NeXoAccountDialog* nexo_account_dialog_instance = nullptr;
    ...
    void SyncNeXoHistory();

    void NeXoByamlMarkSkipped(u64 title_id) const;
    bool NeXoByamlDownload(u64 title_id);
    void RunNeXoByamlDownloadWithProgress(u64 title_id);

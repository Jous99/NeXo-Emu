...
const bool show_online = Common::NeXoAccount::IsLinked() &&
                         NeXo::CompatibleTitles::Table().contains(m_current_program_id);
if (show_online) {
    const int players = NeXo::OnlineCounts::For(m_current_program_id);

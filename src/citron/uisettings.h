                        ...
                        Setting<bool> hide_mouse{
                            ...
                            Setting<bool> controller_applet_disabled{linkage, false, "disableControllerApplet",
                                ...
                                Setting<bool> select_user_on_boot{linkage,
                                    ...
                                    Setting<bool> nexo_notifications_enabled{linkage, true, "nexo/notificationsEnabled", Category::Ui};

                                    // 0 = top-right, 1 = top-left, 2 = bottom-right, 3 = bottom-left. See NeXoToast::Corner.
                                    Setting<int> nexo_notification_corner{linkage, 0, "nexo/notificationCorner", Category::Ui};

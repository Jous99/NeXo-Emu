...
NeXoStatusCluster::NeXoStatusCluster(QWidget* parent) : QWidget(parent) {
    setAttribute(Qt::WA_TransparentForMouseEvents);
    connect(&timer, &QTimer::timeout, this, &NeXoStatusCluster::Tick);
    timer.start(1000);
    RefreshNetwork();
    SetScale(1.0);
}

void NeXoStatusCluster::SetScale(qreal scale) {
...
void NeXoStatusCluster::RefreshNetwork() {
...
void NeXoStatusCluster::paintEvent(QPaintEvent*) {
    QPainter p(this);

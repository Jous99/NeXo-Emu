...
class NeXoFriendItem : public QStandardItem {
public:
    ...
    NeXoFriendItem(u64 pid, const QString& name, const QString& friend_code, s32 presence,
...
class NeXoHistoryItem : public QStandardItem {
public:
    ...
    NeXoHistoryItem(const QString& title_id, const QString& name, const QString& icon_b64,

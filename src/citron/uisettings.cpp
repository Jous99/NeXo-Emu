...
namespace UISettings {
    const std::array<Shortcut, 35> default_hotkeys{{
        ...
        {QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Toggle NeXo Account")).toStdString(),  QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Main Window")).toStdString(), {std::string("Ctrl+F"),  std::string("Home+X"), Qt::WindowShortcut, false}},

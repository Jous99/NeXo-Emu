...
// Only one game version per title can reach NeXo's servers; there's no server-side
...
// Common::NeXoAccount lives here instead of in either layer alone.
namespace NeXo::CompatibleTitles {

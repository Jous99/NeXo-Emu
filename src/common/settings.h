...
// Only read/write enable_raw_input on Windows platforms
    ...
    Setting<std::string> lobby_api_url{linkage, "api.ynet-fun.xyz", "lobby_api_url",
                                       Category::Network};
    Setting<bool> enable_nexo{linkage, false, "enable_nexo", Category::Network};
    Setting<std::string> nexo_server_ip{linkage, "", "nexo_server_ip",
                                            Category::Network};
    Setting<std::string> nexo_nat_ip{linkage, "", "nexo_nat_ip",
                                         Category::Network};
    Setting<std::string> nexo_pid{linkage, "", "nexo_pid", Category::Network};

...
void KScheduler::SwitchThread(KThread* next_thread) {
    ...
    // [NeXo][DIAG] Disabled: measured at ~19,000 log calls/sec across cores during the exact
    ...
    if (false && Svc::IsNeXoDeadlineWatchActive()) {
        // [NeXo][DIAG] KThread::GetContext() gives the thread's last-saved PC/LR directly --
        ...
        LOG_INFO(Kernel,
                 "[NeXo][SCHED-WATCH] core={} {}(id={},prio={},pc={:#x},lr={:#x}) -> {}(id={},prio={})",

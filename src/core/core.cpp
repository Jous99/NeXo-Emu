...
struct System::Impl {
    ...
    /// Raptor Network online connection manager (NeXoEmu online services)
    OnlineInitiator online_initiator;
...
OnlineInitiator& System::GetOnlineInitiator() {
    return impl->online_initiator;
}

const OnlineInitiator& System::GetOnlineInitiator() const {
    return impl->online_initiator;
}
